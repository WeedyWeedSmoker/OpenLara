...
#if !defined(__LIBRETRO__) && (defined(_OS_WIN) || defined(_OS_LINUX) || defined(_OS_PSP) || defined(_OS_RPI) || defined(_OS_PSV)) || defined(INV_QUALITY)
...
#if defined(INV_GAMEPAD_ONLY) || if !defined(__LIBRETRO__)
...
#endif
#if !(defined(INV_GAMEPAD_ONLY) && defined(INV_GAMEPAD_NO_TRIGGER)) || if !defined(__LIBRETRO__)
