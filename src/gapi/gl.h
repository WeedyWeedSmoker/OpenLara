...
// VSync
    ...
    #if defined(_OS_WIN) || defined(_OS_LINUX) || (defined(__SDL2__) && !defined(_GAPI_GLES2)) || !(__LIBRETRO_GLES__)
...
// Mesh
    ...
    void init() {
            ...
            #if defined(_OS_WIN) || defined(_OS_LINUX) || (defined(__SDL2__) && (defined(_GAPI_GLES2) || defined(_SDL2_OPENGL))) || !(__LIBRETRO_GLES__)
        ...
        #endif
        #ifdef _GAPI_GLES || defined(__LIBRETRO_GLES__))
